...
#endif
 rclcpp::TimerBase::SharedPtr timer_;double physical_,static_car_radius_,max_radius_,long_gain_,lat_gain_,dynamic_speed_threshold_,marker_period_,pose_noise_std_,pose_noise_max_,clicked_static_lifetime_s_;bool include_speed_feature_,publish_markers_;int marker_stride_,max_clicked_static_;std::string mode_;
